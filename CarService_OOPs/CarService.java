...
class ServiceBill {
    ...
    public ServiceBill(Vehicle vehicle) {
        this.vehicle = vehicle;
        services = new ArrayList<>();
    }

    public void addService(String serviceCode) {
        Service service = ServiceFactory.getService(serviceCode);
        if (service != null) {
...
public class CarService {
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to the Vehicle Service Station");
        ...
        ServiceBill serviceBill = new ServiceBill(vehicle);
        ...
        while (true) {
            ...
            serviceBill.addService(serviceCode);
        }

        int totalBill = serviceBill.calculateTotalBill();
